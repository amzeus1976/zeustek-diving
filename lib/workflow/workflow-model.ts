...
export const WORKFLOW_ROUTES: WorkflowRoute[] = [
  ...
  { route: 'Diving Calendar & Bookings', label: 'Diving Calendar & Bookings', legacyLabels: ['Bookings', 'Schedule'], section: 'planning', implemented: false, futureTask: 'Future roadmap', description: 'Simple booked and planned diving activity intake.' },
  ...
  { route: 'Gas Planning', label: 'Gas Planning', legacyLabels: [], section: 'planning', implemented: false, futureTask: 'Future roadmap', description: 'Gas plan linked to a current Dive Plan.' },
