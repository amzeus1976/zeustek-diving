...
- The owner authorised a scoped release through Stage8. Stage9 non-blocking editor migration/finishing, optional topic card and disabled public/API profile remain deferred in the issue matrix. Live Gmail acceptance has **not** run. Production is still app1.0.52 / Sites124; GitHub main is still baseline `b2e86827c19239776c80b51fc93067c7dc4b18ac`.
